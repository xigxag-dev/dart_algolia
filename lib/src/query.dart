...
class AlgoliaQuery {
  ...
  Future<AlgoliaQuerySnapshot> getObjects() async {
    ...
    // print("AG BODY - $body");
    return  AlgoliaQuerySnapshot._(algolia, _index, response.data);
  }


  /// browseObjects

  Future<AlgoliaBrowseSnapshot> browseObjects({required String cursor}) async {
    if (_parameters.containsKey('minimumAroundRadius')) {
      assert(
      (_parameters.containsKey('aroundLatLng') ||
          _parameters.containsKey('aroundLatLngViaIP')),
    ...
    var url = '${algolia._host}indexes/$_index/browse';
    ...
    // Map<String, dynamic> body = json.decode(response.data);
    // print("AG BODY - $body");
    return AlgoliaBrowseSnapshot._(algolia, _index, response.data);
  }
